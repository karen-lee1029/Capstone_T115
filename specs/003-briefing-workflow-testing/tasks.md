...
| **T029** (FR-039 traceability record) | The scenario map held 25 of 34 verifications, and tracked re-verification used sibling shorthand that the self-check could not guard | All forty-one verifications mapped; sibling shorthand replaced with explicit citations; a second self-check added guarding *exists implies mapped* |
